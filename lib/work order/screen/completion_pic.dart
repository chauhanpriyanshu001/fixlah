...
class CompleteionCameraCaptureScreen extends StatefulWidget {
  const CompleteionCameraCaptureScreen({super.key});

  @override
  State<CompleteionCameraCaptureScreen> createState() =>
      _CompleteionCameraCaptureScreenState();
}

class _CompleteionCameraCaptureScreenState
    extends State<CompleteionCameraCaptureScreen> {
